  ...
  return (
    <div className="flex flex-wrap gap-4 mb-8 items-center">
      <div className="flex-1 max-w-md relative">
        ...
        <input
          type="text"
          className="pl-10 pr-4 py-2 w-full rounded-lg border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
