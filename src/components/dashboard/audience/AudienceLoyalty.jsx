...
import { audienceLoyaltyData, COLORS } from "../../../data/dashboardData";
import {
  getTooltipStyles,
  getGridColor,
  getAxisColor,
...
export default function AudienceLoyalty({ timeRange, darkMode }) {
  ...
  return (
    <div className="bg-white dark:bg-dark p-6 rounded-xl shadow-sm border border-slate-100 dark:border-gray-700">
      ...
      <ResponsiveContainer width="100%" height={300}>
        <BarChart
          data={audienceLoyaltyData[timeRange]}
          layout="vertical"
        ...
        >
          ...
          <Bar dataKey="value" radius={[0, 4, 4, 0]}>
            {audienceLoyaltyData[timeRange].map((_, index) => (
              <Cell
                key={`cell-${index}`}
