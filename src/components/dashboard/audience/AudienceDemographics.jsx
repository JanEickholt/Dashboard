...
import { audienceDemographics, COLORS } from "../../../data/dashboardData";
import {
  getTooltipStyles,
  getGridColor,
  getAxisColor,
...
export default function AudienceDemographics({ timeRange, darkMode }) {
  ...
  return (
    <div className="bg-white dark:bg-dark p-6 rounded-xl shadow-sm border border-slate-100 dark:border-gray-700">
      ...
      <ResponsiveContainer width="100%" height={300}>
        <BarChart
          data={audienceDemographics[timeRange]}
        ...
        >
          ...
          <Bar dataKey="value" radius={[4, 4, 0, 0]}>
            {audienceDemographics[timeRange].map((_, index) => (
              <Cell
                key={`cell-${index}`}
